...
function getRenderDispatcher() {
  ...
  return (_b =
    (_a =
      ...
      null || _a === void 0
      ? void 0
      : _a.ReactCurrentDispatcher) === null || _b === void 0
    ? void 0
    : _b.current;
}
...
function useInternalState(client, query) {
  ...
  state.forceUpdateState = React__namespace.useReducer(function (tick) {
    return tick + 1;
  }, 0)[1];
  return state;
}
var InternalState = (function () {
  ...
  InternalState.prototype.executeQuery = function (options) {
    ...
    this.previousData =
      ((_a = this.result) === null || _a === void 0 ? void 0 : _a.data) ||
      this.previousData;
    this.result = void 0;
    this.forceUpdate();
  ...
  InternalState.prototype.useQuery = function (options) {
    var _this = this;
    this.renderPromises = React__namespace.useContext(
    ...
    var result = useSyncExternalStore(
      React__namespace.useCallback(
        ...
        [obsQuery, this.renderPromises, this.client.disableNetworkFetches]
      ),
      function () {
  ...
  InternalState.prototype.useOptions = function (options) {
    var _a;
    var watchQueryOptions = this.createWatchQueryOptions(
      (this.queryHookOptions = options)
    );
  ...
  InternalState.prototype.createWatchQueryOptions = function (_a) {
    ...
    if (skip) {
      ...
      watchQueryOptions.fetchPolicy =
        ((_b = this.observable) === null || _b === void 0
          ? void 0
          : _b.options.initialFetchPolicy) || this.getDefaultFetchPolicy();
    }
  ...
  InternalState.prototype.getDefaultFetchPolicy = function () {
    var _a, _b;
    return (
      ((_a = this.queryHookOptions.defaultOptions) === null || _a === void 0
        ? void 0
        : _a.fetchPolicy) ||
      ((_b = this.client.defaultOptions.watchQuery) === null || _b === void 0
        ? void 0
        : _b.fetchPolicy) ||
      "cache-first"
    );
  ...
  InternalState.prototype.useObservableQuery = function () {
    ...
    this.obsQueryFields = React__namespace.useMemo(
      function () {
        return {
  ...
  InternalState.prototype.handleErrorOrCompleted = function (
    result,
    previousResult
  ) {
    var _this = this;
      ...
      Promise.resolve()
        .then(function () {
          if (error_1) {
            ...
            result?.data &&
            (previousResult === null || previousResult === void 0
              ? void 0
              : previousResult.networkStatus) !== result.networkStatus &&
  ...
  InternalState.prototype.toQueryResult = function (result) {
    ...
    this.toQueryResultCache.set(
      result,
      (queryResult = tslib.__assign(
        tslib.__assign(
          tslib.__assign({ data: data }, resultWithoutPartial),
          this.obsQueryFields
        ),
        {
          client: this.client,
...
function useLazyQuery(query, options) {
  ...
  var document =
    (_a = merged === null || merged === void 0 ? void 0 : merged.query) !==
      null && _a !== void 0
      ? _a
      : query;
  optionsRef.current = options;
  queryRef.current = document;
  var internalState = useInternalState(
    useApolloClient(options && options.client),
    document
  );
  var useQueryResult = internalState.useQuery(
    tslib.__assign(tslib.__assign({}, merged), {
  ...
  var eagerMethods = React__namespace.useMemo(function () {
    ...
    for (
      var _i = 0, EAGER_METHODS_1 = EAGER_METHODS;
      _i < EAGER_METHODS_1.length;
      _i++
    ) {
  ...
  var execute = React__namespace.useCallback(function (executeOptions) {
    execOptionsRef.current = executeOptions
      ? tslib.__assign(tslib.__assign({}, executeOptions), {
          fetchPolicy: executeOptions.fetchPolicy || initialFetchPolicy,
        })
      : {
          fetchPolicy: initialFetchPolicy,
        };
    var options = utilities.mergeOptions(
      optionsRef.current,
      tslib.__assign({ query: queryRef.current }, execOptionsRef.current)
    );
    var promise = internalState
      .executeQuery(
        tslib.__assign(tslib.__assign({}, options), { skip: false })
      )
    ...
    return client
      ...
      .then(function (response) {
        ...
        var onError =
          ...
          ((_a = ref.current.options) === null || _a === void 0
            ? void 0
            : _a.onError);
        if (error && onError) {
        ...
        if (
          ...
          if (
            ref.current.isMounted &&
            !equality.equal(ref.current.result, result_1)
          ) {
            setResult((ref.current.result = result_1));
          }
        }
        var onCompleted =
          executeOptions.onCompleted ||
          ((_b = ref.current.options) === null || _b === void 0
            ? void 0
            : _b.onCompleted);
        if (!error) {
...
function useSubscription(subscription, options) {
  ...
  var _a = React__namespace.useState({
      loading: !(options === null || options === void 0
        ? void 0
        : options.skip),
      error: void 0,
      data: void 0,
  ...
  if (!hasIssuedDeprecationWarningRef.current) {
    ...
    if (
      ...
      globalThis.__DEV__ !== false &&
        globals.invariant.warn(options.onData ? 52 : 53);
    }
    if (
      options === null || options === void 0
        ? void 0
      ...
      globalThis.__DEV__ !== false &&
        globals.invariant.warn(options.onComplete ? 54 : 55);
    }
  }
  var _b = React__namespace.useState(function () {
      ...
      return client.subscribe({
        ...
        variables:
          options === null || options === void 0 ? void 0 : options.variables,
        fetchPolicy:
          options === null || options === void 0 ? void 0 : options.fetchPolicy,
        context:
        ...
        (shouldResubscribe !== false &&
          (client !== ref.current.client ||
            ...
            !(options === null || options === void 0
              ? void 0
              : options.skip) !==
              !((_c = ref.current.options) === null || _c === void 0
                ? void 0
                : _c.skip) ||
            !equality.equal(
              options === null || options === void 0
                ? void 0
                : options.variables,
              (_d = ref.current.options) === null || _d === void 0
                ? void 0
                : _d.variables
            ))) ||
        canResetObservableRef.current
  ...
  return useSyncExternalStore(
    React__namespace.useCallback(
      function (forceUpdate) {
        var lastTimeout = 0;
        var unsubscribe = cache.watch(
          tslib.__assign(tslib.__assign({}, diffOptions), {
            immediate: true,
...
function diffToResult(diff) {
  ...
  if (diff.missing) {
    result.missing = utilities.mergeDeepArray(
      diff.missing.map(function (error) {
...
function _useSuspenseQuery(query, options) {
  ...
  var cacheKey = tslib.__spreadArray(
    [query, cache.canonicalStringify(variables)],
    [].concat(queryKey),
    true
  );
  ...
  var _b = React__namespace.useState([queryRef.key, queryRef.promise]),
    current = _b[0],
    setPromise = _b[1];
  ...
  var skipResult = React__namespace.useMemo(
    function () {
      ...
      return {
        ...
        networkStatus: error
          ? core.NetworkStatus.error
          : core.NetworkStatus.ready,
        error: error,
      };
    },
    [queryRef.result]
  ...
  var refetch = React__namespace.useCallback(
    function (variables) {
  ...
  var subscribeToMore = React__namespace.useCallback(
    function (options) {
...
function useWatchQueryOptions(_a) {
  ...
  return useDeepMemo(
    function () {
      ...
      var fetchPolicy =
        options.fetchPolicy ||
        ((_a = client.defaultOptions.watchQuery) === null || _a === void 0
          ? void 0
          : _a.fetchPolicy) ||
        "cache-first";
      var watchQueryOptions = tslib.__assign(tslib.__assign({}, options), {
...
function _useBackgroundQuery(query, options) {
  ...
  var _b = React__namespace.useState(internal.wrapQueryRef(queryRef)),
...
function useLoadableQuery(query, options) {
  ...
  if (
    queryRef &&
    (internalQueryRef === null || internalQueryRef === void 0
      ? void 0
      : internalQueryRef.didChangeOptions(watchQueryOptions))
  ) {
  ...
  var loadQuery = React__namespace.useCallback(
    function () {
      var args = [];
      ...
      var queryRef = suspenseCache.getQueryRef(cacheKey, function () {
        return client.watchQuery(
          tslib.__assign(tslib.__assign({}, watchQueryOptions), {
            variables: variables,
          })
        );
      });
  ...
  return [
    loadQuery,
    queryRef,
    { fetchMore: fetchMore, refetch: refetch, reset: reset },
  ];
}

function useQueryRefHandlers(queryRef) {
  var _a = React__namespace.useState(queryRef),
    previousQueryRef = _a[0],
    setPreviousQueryRef = _a[1];
  var _b = React__namespace.useState(queryRef),
    wrappedQueryRef = _b[0],
    setWrappedQueryRef = _b[1];
  ...
  if (previousQueryRef !== queryRef) {
    ...
    internal.updateWrappedQueryRef(
      queryRef,
      internal.getWrappedPromise(wrappedQueryRef)
    );
  }
  var refetch = React__namespace.useCallback(
    function (variables) {
...
function useReadQuery(queryRef) {
  return wrapHook(
    "useReadQuery",
    _useReadQuery,
    internal.unwrapQueryRef(queryRef)["observable"]
  )(queryRef);
}
function _useReadQuery(queryRef) {
  var internalQueryRef = React__namespace.useMemo(
    function () {
      return internal.unwrapQueryRef(queryRef);
    },
    [queryRef]
  );
  var getPromise = React__namespace.useCallback(
    function () {
  ...
  var promise = useSyncExternalStore(
    React__namespace.useCallback(
      function (forceUpdate) {
